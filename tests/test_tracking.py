...
def test_get_latest_events_empty(db_path):
    ...
    assert result == {
        "tx-001": {"exported_at": None, "netsuite_at": None, "emailed_at": None, "so_digest_at": None, "finale_at": None, "gap_digest_at": None},
        "tx-002": {"exported_at": None, "netsuite_at": None, "emailed_at": None, "so_digest_at": None, "finale_at": None, "gap_digest_at": None},
    }
